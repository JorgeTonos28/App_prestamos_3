            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-white border border-surface-100 rounded-xl p-4">
                        <p class="text-xs text-surface-500 uppercase">Capital</p>
                        <p class="text-lg font-bold text-surface-800">{{ formatCurrency(summary.principal) }}</p>
                    </div>
                    <div class="bg-white border border-surface-100 rounded-xl p-4">
                        <p class="text-xs text-surface-500 uppercase">Intereses</p>
                        <p class="text-lg font-bold text-surface-800">{{ formatCurrency(summary.interest) }}</p>
                    </div>
                    <div class="bg-white border border-surface-100 rounded-xl p-4">
                        <p class="text-xs text-surface-500 uppercase">Mora</p>
                        <p class="text-lg font-bold text-surface-800">{{ formatCurrency(summary.late_fees) }}</p>
                    </div>
                    <div class="bg-white border border-surface-100 rounded-xl p-4">
                        <p class="text-xs text-surface-500 uppercase">Gastos Legales</p>
                        <p class="text-lg font-bold text-surface-800">{{ formatCurrency(summary.legal_fees) }}</p>
                    </div>
                </div>

                <div class="bg-surface-900 text-white rounded-xl p-5 flex items-center justify-between">
                    <div>
                        <p class="text-xs uppercase text-surface-300">Total a Pagar</p>
