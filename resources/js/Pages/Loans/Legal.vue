                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow v-for="loan in loans.data" :key="loan.id" class="hover:bg-surface-50 transition-colors">
                                ...
                                <TableCell>
                                    <Badge variant="outline" class="rounded-md w-fit text-warning-700 border-warning-200 bg-warning-50">
                                        Legal
                                    </Badge>
                                    <div v-if="loan.arrears_info && loan.arrears_info.amount > 0" class="text-xs font-bold text-danger-600 mt-1">
